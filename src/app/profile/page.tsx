...
//   title: "Next.js Profile | Agua - Next.js Dashboard Template",
//   description:
//     "This is Next.js Profile page for Agua - Next.js Tailwind CSS Admin Dashboard Template",
// };
...
const Profile: React.FC = () => {
  return (
    ...
    <div className="p-6 font-sans">
      {/* First div */}
      <div className="flex items-center gap-6 mb-8 p-4 border border-gray-300 rounded-lg bg-gray-100">
  ...
  />
        ...
        <div className="space-y-2">
          <p><span className="font-bold">Name:</span> Umaria</p>
          <p><span className="font-bold">Email:</span> umar.developer@example.com</p>
          <p><span className="font-bold">Wallet Address:</span> 0x1234...abcd</p>
        </div>
      </div>

       {/* Second div for Treasury */}
       <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Treasury</h1>
        <div className="flex gap-4">
          {/* First token card (Gold) */}
          <div className="flex-1 p-4 bg-gray-200 border border-gray-300 rounded-lg text-center shadow-sm hover:bg-gray-300 cursor-pointer relative">
            <div className="absolute top-3 left-2 w-20 h-20">
              <img src="images\logo\Gold.png" alt="Gold Token Logo" className="w-full h-full object-cover" />
            </div>
            <div className=" mt-3 text-lg font-bold text-black font-semibold">
              $1000
            </div>
          ...
          {/* Second token card (Silver) */}
          <div className="flex-1 p-4 bg-gray-200 border border-gray-300 rounded-lg text-center shadow-sm hover:bg-gray-300 cursor-pointer relative">
            <div className="absolute top-3 left-2 w-20 h-20">
              <img src="images\logo\sliver.png" alt="Silver Token Logo" className="w-full h-full object-cover" />
            </div>
            <div className=" mt-3 text-lg font-bold text-black font-semibold">
              $2000
            </div>
          ...
          {/* Third token card (Community Token) */}
          <div className="flex-1 p-4 bg-gray-200 border border-gray-300 rounded-lg text-center shadow-sm hover:bg-gray-300 cursor-pointer relative">
            <div className="absolute top-3 left-2 w-20 h-20">
              <img src="images\logo\community.png" alt="Community Token Logo" className="w-full h-full object-cover" />
            </div>
            <div className=" mt-3 text-lg font-bold text-black font-semibold">
              $3000
            </div>
